...
df_gc_freq.to_csv('gc_freq.csv', sep=',', encoding='utf-8')
df_nucl_freq.to_csv('nucl_freq.csv', sep=',', encoding='utf-8')
df_dinucl_freq.to_csv('dinucl_freq.csv', sep=',', encoding='utf-8')
